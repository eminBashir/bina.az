    ...
    public partial class mig1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "AnnouncmentsStatus",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    StatusID = table.Column<int>(type: "int", nullable: false),
                    AnnoucmentID = table.Column<int>(type: "int", nullable: false),
                    ValidityPeriod = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AnnouncmentsStatus", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "AnnouncmentsType",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AnnouncmentsType", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Announcments_Categories_CategoriesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AnnouncmentsImages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AnnouncmentsImages_Announcments_AnnouncmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Favorits_Announcments_AnnouncmentID",
                        column: x => x.AnnouncmentID,
                        principalTable: "Announcments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Announcments_CategoriesId",
                table: "Announcments",
                column: "CategoriesId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnnouncmentsImages_AnnouncmentId",
                table: "AnnouncmentsImages",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Favorits_AnnouncmentID",
                table: "Favorits",
                column: "AnnouncmentID");
